public class BabysitterTest {
	...
	//Test 8
	public void BabysitterShowsUpAsEarlyAsPossibleAndMakesAsMuchMoneyAsPossible() {
		bs = new Babysitter(5,4,12);
		assertInt(148, bs.payout(), 8);
	}
	...
	public static void main(String [] args) {
		...
		bst.BabysitterShowsUpAsEarlyAsPossibleAndMakesAsMuchMoneyAsPossible();
	}
}